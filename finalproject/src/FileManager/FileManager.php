...
class FileManager
{
    ...
    {
        $this->baseDir = realpath(__DIR__ . '/../../public/assets/') ?: '';
        $this->allowedDirs = [
            $this->baseDir . '/css',
            $this->baseDir . '/js',
            $this->baseDir . '/html',
    ...
    private function displayDirectoryContents(string $fullPath, string $requestedPath): void
    {
        ...
        require_once  '/var/www/finalproject/public/views/admin/admin.php';
    }
    ...
    private function resolveRequestedPath(string $requestedPath): ?string
    {
        ...
        if (!$fullPath || !str_starts_with($fullPath, $this->baseDir)) {
